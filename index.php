...
<div class="product-card">
    ...
    <div class="product-info">
        <div class="product-footer-price">
            ...
            <button class="btn-cart-icon" data-id="<?= $p['id'] ?>" <?=$p['stock'] <=0
        ...
        <p style="font-size:0.75rem; color:#f59e0b; margin-top:6px;">
            <i class="fas fa-exclamation-triangle"></i> Plus que
            <?= $p['stock'] ?> en stock !
        </p>
...
<body>
    ...
    <header class="navbar">
        <div class="nav-container">
            ...
            <!-- Rayons dynamiques -->
            <div class="dropdown">
                <button class="btn-nav">Rayons <i class="fa-solid fa-chevron-down"
            ...
            <nav class="nav-actions">
                ...
                <a href="client/panier.php" class="btn-nav btn-primary" id="btn-panier">
                    ...
                    <?php
                        ...
                        if ($nb_panier > 0): ?>
                    <span
                        style="background:white;color:#E63946;border-radius:50%;width:20px;height:20px;display:inline-flex;align-items:center;justify-content:center;font-size:0.75rem;font-weight:700;margin-left:4px;">
                        <?= $nb_panier ?>
                    </span>
                    <?php endif; ?>
                </a>
    ...
    <section class="product-section bg-light">
        <div class="container">
            <h2 class="section-title">
                <?= $recherche ? '🔍 Résultats pour "' . htmlspecialchars($recherche) . '"' : '🏷️ ' . htmlspecialchars($cat_filtre) ?>
                <span style="font-size:1rem; color:#6c757d; font-family:'DM Sans',sans-serif; font-weight:400;">
                    (
                    <?= count($resultats) ?> produit
                    <?= count($resultats) > 1 ? 's' : '' ?>)
                </span>
            </h2>
    ...
    <footer class="footer">
        <div class="container">
            ...
            <div class="footer-bottom">
                <p>&copy;
                    <?= date('Y') ?> NovaStore. Tous droits réservés.
                </p>
            </div>
        </div>
    </footer>
