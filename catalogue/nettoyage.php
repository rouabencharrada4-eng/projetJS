<?php
// ============================================================
//   NOVASTORE - catalogue/nettoyage.php
// ============================================================
...
// Produits depuis la DB pour la catégorie Nettoyage
$stmt = $pdo->prepare('
    SELECT p.*, c.nom AS categorie
    FROM produits p
    JOIN categories c ON c.id = p.categorie_id
    WHERE c.slug = "nettoyage" AND p.actif = 1
...
// Les 2 nouveaux produits demandés
$produits_extra = [
    [
        'id'          => 'nettoyage-1',
        'badge'       => 'Indispensable',
        'nom'         => 'Lessive en poudre regular',
        'marque'      => 'NADHIF',
        'modele'      => 'Sachet de 300g',
        'prix'        => 1.990,
        'stock'       => 50,
        'image'       => '../images/nadhif.jpg',
        'note_moyenne'=> 4.5,
        'nb_avis'     => 120,
    ],
    [
...
function carteProduit($p, $wishlist_ids) {
    ...
    $is_extra    = str_starts_with((string)($p['id'] ?? ''), 'nettoyage-');
    ob_start();
    ?>
        ...
        <div class="product-info">
            <div class="product-footer-price">
                ...
                <button class="btn-cart-icon"
                    <?= !$is_extra ? 'data-id="' . $p['id'] . '"' : 'onclick="alert(\'Produit ajouté au panier !\')"' ?>
...
<section class="product-section" style="padding:50px 0;">
    <div class="container">
        ...
        <div class="page-banner">
            <h3>L'essentiel du Ménage</h3>
            <p>Tout pour une maison propre et saine au meilleur prix</p>
        </div>
        ...
        <div class="products-grid">
            ...
            <!-- Nouveaux produits ajoutés manuellement -->
