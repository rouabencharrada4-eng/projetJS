<?php
// ============================================================
//   NOVASTORE - catalogue/vetements.php
//   Page principale Vêtements — Homme + Femme
// ============================================================
    ...
    <div class="vetement-card">
        ...
        <div class="vetement-body">
            <div class="vetement-header">
                ...
                <div class="vetement-price"><?= $prix_parts[0] ?>.<span style="font-size:0.8rem;"><?= $prix_parts[1] ?? '000' ?></span> DT</div>
            </div>
            ...
            <div class="couleurs-row">
                ...
                <?php if (isset($c['hex2'])): ?>
                <div class="couleur-dot bicolor" style="--c1:<?= $c['hex'] ?>;--c2:<?= $c['hex2'] ?>;" title="<?= $c['nom'] ?>"></div>
                <?php else: ?>
                <div class="couleur-dot" style="background:<?= $c['hex'] ?>;<?= $c['hex']==='#f9fafb'?'border-color:#dee2e6;':'' ?>" title="<?= $c['nom'] ?>"></div>
                <?php endif; ?>
                <?php endforeach; ?>
            </div>

            <a href="<?= htmlspecialchars($p['lien']) ?>" class="btn-commander">
                <i class="fas fa-shopping-bag"></i> Choisir & Commander
            </a>
        </div>
    </div>
    <?php
...
<head>
    ...
    <style>
        ...
        .section-label h3 { font-family:'Playfair Display',serif; font-size:1.4rem; color:#1D3557; margin:0; }
        .section-label a {
            margin-left:auto; font-size:0.88rem; color:#E63946;
        ...
        .vetement-img { width:100%; height:260px; object-fit:cover; background:#f8f9fa; }
        .vetement-body { padding:18px; }
        .vetement-header { display:flex; justify-content:space-between; align-items:flex-start; margin-bottom:10px; }
        .vetement-name { font-size:1rem; font-weight:700; color:#1D3557; }
        .vetement-modele { font-size:0.82rem; color:#6c757d; margin-top:2px; }
        .vetement-price { font-size:1.2rem; font-weight:700; color:#007bff; white-space:nowrap; }
        .vetement-rating { color:#ffc107; font-size:0.82rem; display:flex; gap:2px; margin:10px 0; }

        .options-label { font-size:0.78rem; font-weight:700; color:#374151; text-transform:uppercase; letter-spacing:0.5px; margin:12px 0 7px; }

        .tailles-row { display:flex; gap:6px; flex-wrap:wrap; }
        .taille-pill { padding:4px 10px; border-radius:6px; border:1.5px solid #e9ecef; font-size:0.78rem; font-weight:700; color:#374151; background:white; }

        .couleurs-row { display:flex; gap:7px; flex-wrap:wrap; margin-top:2px; }
        .couleur-dot {
            width:24px; height:24px; border-radius:50%;
            border:2.5px solid #e9ecef; flex-shrink:0;
            position:relative; cursor:default;
        }
        .couleur-dot.bicolor { background:linear-gradient(135deg, var(--c1) 50%, var(--c2) 50%); }
...
<section style="padding:50px 0;">
    <div class="container">
        ...
        <div class="page-banner">
            <h3>Rayon Vêtements</h3>
            <p>Collections Homme & Femme — Tailles XS, S, M, L, XL disponibles</p>
        </div>
        ...
        <div class="section-label">
            ...
            <a href="vetements/femme.php">Voir tout <i class="fas fa-arrow-right"></i></a>
        </div>
        ...
        <div class="section-label">
            ...
            <a href="vetements/homme.php">Voir tout <i class="fas fa-arrow-right"></i></a>
        </div>
        <div class="vetement-grid">
